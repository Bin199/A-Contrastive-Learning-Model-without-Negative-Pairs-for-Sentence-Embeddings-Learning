...
class ModelArguments:
    ...
    informin_cl_coefficient: int = field(
        default = 0.5,
        metadata = {
            "help": "coefficient of informin loss"
        }
    )
...
def main():
    ...
    if not(wandb.run.name is None):
        ...
        output_name = 'scd-align_uniformity_loss-steps=125'
    ...
    config.multi_dropout = False
    config.single_dropout = True
    ...
    print('batch size== 192')
    print('learning rate == 3e-5')
    print('lambda:',model_args.informin_cl_coefficient)
    print('*'*30)
    return results
